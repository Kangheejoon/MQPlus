...
namespace DFRobotMaqueenPlus {
     ...
     */
    //% weight=80
    //% block="모터|%index|방향|%direction|속도|%speed "
     ...
     */
    //% weight=61
    //%block="모터 읽기|%index 방향(정지:0,앞으로:1,뒤로:2)"
     ...
     */
    //% weight=20
    //%block="초음파 센서 읽기 TRIG %T ECHO %E 단위:CM"
